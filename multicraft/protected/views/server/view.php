    ...
    <div id="buttons" class="row">
        <?php
            echo CHtml::ajaxButton(Yii::t('mc', 'Start'), '', array(
                ...
                $data['buttons'][0] != '1' ? array('class' => 'btn btn-success') : array('disabled'=>'disbled', 'class' => 'btn btn-success'));
        ?>
        <?php
            echo CHtml::ajaxButton(Yii::t('mc', 'Stop'), '', array(
                ...
                $data['buttons'][1] != '1' ? array('class' => 'btn btn-danger') : array('disabled'=>'disbled', 'class' => 'btn btn-danger'));
        ?>
        <?php
